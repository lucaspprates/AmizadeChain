...
GUARD_COMMIT="12fe06bc7c796f8d10e7731ce6a97018888c94e1"
GUARD_BLOB="adec443c25f900fd1412749e96f5cdcdc991f21e"
GUARD_URL="https://raw.githubusercontent.com/lucaspprates/AmizadeChain/${GUARD_COMMIT}/tmp/onca-8x1-v4/15b_onca_codex_auth_guard_v43.sh"
GUARD_TARGET="/tmp/15b_onca_codex_auth_guard_v43.sh"
...
fail() {
  ...
  shift
  echo "ERRO: $*" >&2
  echo "ONCA_PR19_RESTACK_GATE_V43: BLOCKED"
  echo "FAILURE_CODE=$code"
  echo "REMOTE_BRANCH_UPDATED=false"
  echo "NEXT_ACTION=REPAIR_OR_REAUTH_WORKER_THEN_RERUN_SAME_V43_WRAPPER"
  exit 1
}
...
cat <<EOF
ONCA_PR19_RESTACK_GATE_V43_INSTALLER: PASS
AUTH_GUARD_COMMIT=$GUARD_COMMIT
AUTH_GUARD_BLOB=$GUARD_BLOB
RESTACK_COMMIT=$RESTACK_COMMIT
RESTACK_BLOB=$RESTACK_BLOB
EXECUTION_ORDER=EXACT_ENV_AUTH_GUARD_THEN_RESTACK_THEN_EXACT_SHA_GATE
EOF

echo
echo '===== FASE A — CODEX AUTH GUARD NO AMBIENTE EXATO ====='
